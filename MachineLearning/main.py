...
def main():
    ...
    shouldShuffle = True
    preppedDataDict = prepareDataForMLTraining(testSize, dataset_root, shouldShuffle)
    ...
    automated_ml_config = model(preppedDataDict[0], preppedDataDict[2], "FOLDER HARD CODED", 10, 20, 'spearman_correlation', 5, 'regression')
